        ...
        <div class="tab-pane fade show active" id="storiaclinica" role="tabpanel" aria-labelledby="storiaclinica-tab">
            ...
            <div style="width: 90%">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td class="datetd">
                            <input class="form-control" type="date" id="date-input" name="datastoriaclinica" value="{{old('datastoriaclinica')}}">
                        </td>
        ...
        <div class="tab-pane fade" id="interventi" role="tabpanel" aria-labelledby="interventi-tab">
            ...
            <div style="width: 90%">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td class="datetd">
                                <input class="form-control" type="date" id="date-input" name="dataintervento"  value="{{old('dataintervento')}}">
                        </td>

                        <td>
                                    <textarea class="form-control" id="clinic-story-input" rows="3" name="intervento"  value="{{old('intervento')}}"></textarea>
                        </td>
                    </tr>
                    </tbody>
                </table>
