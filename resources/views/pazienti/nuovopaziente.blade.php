        ...
        <form method="POST" action="/nuovopaziente">
            ...
            <div class="container" style="margin-left: 3%!important;">
                ...
                <div class="row formrow">
                    ...
                    <div class="col">
                        {{--<input type="text" class="form-control" placeholder="M/F" name="sesso"  value="{{old('sesso')}}" maxlength="1"required>--}}
                ...
                <div class="row formrow">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" placeholder="Recapito medico curante"
                               name="recapitomedicocurante"  value="{{old('recapitomedicocurante')}}">
                    </div>

                    <div class="col">
                        <input type="text" class="form-control" placeholder="Contatto medico curante"
                               name="contattomedicocurante"  value="{{old('contattomedicocurante')}}">
                    </div>
                </div>
            </div>
