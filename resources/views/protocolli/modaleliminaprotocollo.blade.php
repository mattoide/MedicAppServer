<div class="modal fade" id="modaleliminaprotocollo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <div class="col">
                    <form method="POST" action="/eliminaprotocollo" style="display: inline">
                        {{ csrf_field() }}
                        <button style="width: 100%" id="idprotoz" name="idprotoz" type="submit" class="btn btn-danger">Conferma</button>
                    </form>
                </div>
                <div class="col">
...
<script>
    $('#modaleliminaprotocollo').on('show.bs.modal', function (event) {
  ...
  var idprotocollo = button.data('idprotocollo') // Extract info from data-* attributes
  ...
  console.log(idprotocollo)
  $('#idprotoz').val(idprotocollo)
    })
