<div class="modal fade" id="modaleliminaallergia" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <div class="col">
                    <form method="POST" action="/eliminaallergia" style="display: inline">
                        {{ csrf_field() }}
                        <button style="width: 100%" id="idallergia" name="idallergia" type="submit" class="btn btn-danger">Conferma</button>
                    </form>
                </div>
                <div class="col">
...
<script>
    $('#modaleliminaallergia').on('show.bs.modal', function (event) {
  ...
  var idallergia = button.data('idallergia') // Extract info from data-* attributes
